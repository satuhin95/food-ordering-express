...
import { StripeWrapper } from '../../components/PaymentFrom';
        ...
        <div className="bg-white h-screen text-black mx-auto mt-2 border border-gray-200 p-4 md:w-2/3 rounded-lg shadow-md sm:p-6 lg:p-8">
            ...
            <div className={`tabs ${currentTab !== 'Summary' ? 'hidden':''}`}>
                ...
                <div className="flex justify-end p-2">
                     <Button variant="dark" className="flex items-center" onClick={()=>handleTabSwitch('Delivery')} type="submit"><span className="mr-1">Next</span> <BsArrowRight/> </Button>
                 </div>
            </div>
