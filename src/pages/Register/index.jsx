...
const Register =()=>{
    ...
    const onSubmit = (data)=>{
        ...
        let uid = '';
        createUserWithEmailAndPassword(authentication,data.name,data.password)
                .then((response)=>{
                ...
                <div className="p-10 rounded-xl z-10 w-full h-full bg-black">
                    ...
                    <form className="w-full space-y-6" onSubmit={handleSubmit(onSubmit)}>
                        <div>
                            ...
                            <input {...register('name', { required: true })} id="name" type="text" className="block appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-gray-200 focus:border-gray-200"/>
